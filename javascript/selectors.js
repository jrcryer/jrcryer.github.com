...
(function ($) {
    $.attachHeaders = function (el, options) {
        ...
        base.init = function () {
            base.options = $.extend({}, $.attachHeaders.defaultOptions, options);
    ...
    $.attachHeaders.defaultOptions = {
        fixedOffset: 0
    };

    $.fn.attachHeaders = function (options) {
        return this.each(function () {
            (new $.attachHeaders(this, options));
        });
    };
